...
Every two years, the Center for Disease Control and Prevention conduct the [Youth Risk Behavior Surveillance System (YRBSS)](https://www.cdc.gov/healthyyouth/data/yrbs/index.htm) survey, where it takes data from high schoolers (9th through 12th grade), to analyze health patterns. Together with my study group we will work from a group of variables from a random sample of observations during one of the years the YRBSS was conducted.
...
Using visualization and summary statistics, we describe the distribution of weights.
